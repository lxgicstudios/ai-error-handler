...
<p align="center">
  ...
  <a href="https://github.com/LXGIC-Studios/ai-error-handler/actions">
...
[![License: MIT](https://img.shields.io/npm/l/ai-error-handler.svg?style=for-the-badge&logo=mit&color=blue)](https://github.com/LXGIC-Studios/ai-error-handler/blob/main/LICENSE)
...
```bash
git clone https://github.com/LXGIC-Studios/ai-error-handler.git
cd ai-error-handler
npm install
npm run dev
```
