...
![npm](https://img.shields.io/npm/v/ai-error-handler)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-error-handler)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Advanced error handling and logging utilities

Advanced error handling generator. Creates global error handlers with logging and monitoring.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-error-handler.svg)](https://badge.fury.io/js/ai-error-handler)
